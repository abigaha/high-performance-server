...
| F3 | **连接池实现** | P0 | mutex + cv 固定大小池，ping 健康检查，超时等待 | ✅ |
| F4 | **IConnection 抽象 + BoostMySqlConnection** | P0 | boost::mysql 封装，prepared statement 防注入 | ✅ |
...
| F9 | **MockConnection** | P0 | 无真实数据库可测，14 用例全通过 | ✅ |
...
| 创建 | `db/include/iconnection.h` | ✅ |
| 创建 | `db/include/boost_mysql_connection.h` | ✅ |
| 创建 | `db/include/database_pool.h` | ✅ |
| 创建 | `db/src/boost_mysql_connection.cpp` | ✅ |
...
| T12 | MockConnection 注入 | 单元 | ✅ |
| T13 | Connection ping 健康检查 | 单元 | ✅ |
| T14 | close 等待活跃连接 | 单元 | ✅ |
